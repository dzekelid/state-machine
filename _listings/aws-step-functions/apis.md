...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/state-machine/master/_listings/aws-step-functions/apis.md
...
- name: AWS Step Functions API - Create State Machine
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/state-machine/master/_listings/aws-step-functions/actioncreatestatemachine-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/state-machine/master/_listings/aws-step-functions/actioncreatestatemachine-get-openapi.md
- name: AWS Step Functions API - Delete State Machine
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/state-machine/master/_listings/aws-step-functions/actiondeletestatemachine-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/state-machine/master/_listings/aws-step-functions/actiondeletestatemachine-get-openapi.md
- name: AWS Step Functions API - Describe State Machine
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/state-machine/master/_listings/aws-step-functions/actiondescribestatemachine-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/state-machine/master/_listings/aws-step-functions/actiondescribestatemachine-get-openapi.md
- name: AWS Step Functions API - List Executions
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/state-machine/master/_listings/aws-step-functions/actionlistexecutions-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/state-machine/master/_listings/aws-step-functions/actionlistexecutions-get-openapi.md
- name: AWS Step Functions API - List State Machines
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/state-machine/master/_listings/aws-step-functions/actionliststatemachines-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/state-machine/master/_listings/aws-step-functions/actionliststatemachines-get-openapi.md
- name: AWS Step Functions API - Start Execution
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/state-machine/master/_listings/aws-step-functions/actionstartexecution-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/state-machine/master/_listings/aws-step-functions/actionstartexecution-get-openapi.md
x-common:
- type: x-api-gallery
